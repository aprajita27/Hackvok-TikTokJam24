...
import 'package:example/view_model/search/search_view_model.dart';
import 'package:example/view_model/user/user_view_model.dart';
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: new InputDecoration(
            ...
            suffixIcon: Icon(Icons.search, size: 15.0, color: Colors.black),
          ),
          onChanged: (query) {
